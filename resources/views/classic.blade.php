...
<!-- Mirrored from diamant.kwst.net/site/room-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jul 2024 05:30:19 GMT -->
    ...
    <div id="main">
        ...
        <header class="main-header">
            <div class="container">
                ...
                <div class="header-top  fl-wrap">
                    <div class="header-top_contacts"><a href="#"><span>Call:</span> 8434608046</a><a href="#"><span>Find
                                us:</span>manokamna nagar tikra toli Piska nagri ranchi Jharkhand 835303 </a></div>
                ...
                <div class="nav-holder-wrap init-fix-header  fl-wrap">
                    <a href="/" class="logo-holder"><img src="images/MHlogoNw.png" alt=""
                            style="width: 105px; height: 55px;"></a>
                    <!--  navigation -->
                    ...
                    <div class="serach-header-btn_wrap">
                        <a class="serach-header-btn"><i class="fa-light fa-magnifying-glass"></i> <span>Serach a
                                Room</span></a>
                    </div>
                    <div class="show-cart sc_btn   htact"><i class="fa-light fa-basket-shopping-simple"></i><span
                            class="show-cart_count">2</span><span class="header-tooltip">Your Wishlist</span></div>
                    ...
                    <div class="wish-list-wrap novis_cart">
                        ...
                        <div class="wish-list-container">
                            ...
                            <div class="wish-list-item fl-wrap">
                                <div class="wish-list-img"><a href="room-single.html"><img
        ...
        <footer class="main-footer">
                            ...
                            <div class="col-lg-3">
                                <div class="footer-widget">
                                    ...
                                    <div class="footer-widget-content">
                                        <p>Welcome to our hotel, where comfort meets elegance. Enjoy luxurious rooms,
                                            exceptional service, and stunning views. Located in the heart of the city,
                                            we promise a memorable and relaxing stay. </p>
                                        <a href="/about" class="footer-widget-content-link"><span>Read
                                                more</span></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="footer-widget">
                                    ...
                                    <div class="footer-widget-content">
                                        <div class="footer-contacts footer-box">
                                            <ul>
                                                <li><span>Call :</span><a href="#">8434608046</a> , <a
                                                        href="#">7903476056</a></li>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <a href="/" class="footer-logo"><img src="images/MHlogoNw.png" alt=""
                            style="width: 105px; height: 55px;"></a>
