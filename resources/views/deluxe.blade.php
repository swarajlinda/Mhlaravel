...
<!-- Mirrored from diamant.kwst.net/site/room-single3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jul 2024 05:30:19 GMT -->
                            ...
                            <div class="dec-container">
                                ...
                                <div class="text-block">
                                    <div class="text-block-title">
                                        ...
                                        <div class="sr-opt">
                                            <div class="sa-price">4299/Night</div>
                                    ...
                                    <div class="room-card-details rcd-single">
                                        <ul>
                                            ...
                                            <li><i class="fa-light fa-user"></i><span>1 to 4 Guest</span></li>
                                            <li><i class="fa-light fa-bed-front"></i><span>2 KING SIZE BED</span></li>
                                    ...
                                    <div class="gallery-items  spad list-single-gallery three-coulms lightgallery">
                                        ...
                                        <div class="gallery-item">
                                            <div class="grid-item-holder hov_zoom">
                                                ...
                                                <a href="images/room/5.jpg" class="box-media-zoom popup-image"><i class="fa fa-search"></i></a>
                                            </div>
                                        </div>
                                        <!-- 5 end -->
                                        <!-- 7 -->
                                        <div class="gallery-item">
                                            <div class="grid-item-holder hov_zoom">
                                                ...
                                                <a href="images/room/6.jpg" class="box-media-zoom popup-image"><i class="fa fa-search"></i></a>
                                            </div>
                                        </div>
                                        <!-- 7 end -->
                                    </div>
                                    ...
                                    <div class="meg_aminites">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-solid fa-bed"></i><span>DOUBLE BEDED WITH KING SIZE </span></div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-solid fa-people-roof"></i><span>ROOF TOP</span></div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-solid fa-shower"></i><span>SHOWER ROOM WITH ROYAL ACCESSORIES </span></div>
                                            </div>
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-solid fa-chess-king"></i><span>ROYAL SERVICE</span></div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-solid fa-mug-saucer"></i><span>T.C.M.</span></div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-solid fa-jug-detergent"></i><span>KETTLE</span></div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-solid fa-person-swimming"></i><span>FREE SWIMING POOL WITH COSTUME </span></div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-solid fa-tv"></i><span>FREE WI-FI,UHD-SMART T.V.</span></div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-solid fa-bed"></i><span>EXTRA BABY BED</span></div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="meg_aminites_item"><i class="fa-light fa-refrigerator"></i><span>MINI FRIDGE</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tbc-separator"></div>
                            ...
                            <div class="fix-bar-init">
                                <div class="fw-search-wrap">
                                    ...
                                    <form class="custom-form" action="{{route('book-room')}}" name="bookform">
                                        @csrf
                                        <input type="hidden" name="roomType" id="roomType" value="deluxe">
                                        <fieldset>
                            ...
                            <div class="col-lg-3">
                                <div class="footer-widget">
                                    ...
                                    <div class="footer-widget-content">
                                        ...
                                        <a href="/contact" class="footer-widget-content-link"><span>Get in Touch</span></a>
                                    </div>
                                </div>
                            </div>
                            <!-- footer-widget  end-->
