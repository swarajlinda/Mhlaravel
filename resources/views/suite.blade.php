                                ...
                                <div class="dec-container">
                                    ...
                                    <div class="text-block">
                                        <div class="text-block-title">
                                            ...
                                            <div class="sr-opt">
                                                <div class="sa-price">3299/Night</div>
                                        ...
                                        <div class="room-card-details rcd-single">
                                            <ul>
                                                ...
                                                <li><i class="fa-light fa-user"></i><span>1 to 2 People</span></li>
                                                <li><i class="fa-light fa-bed-front"></i><span>1 Guest</span></li>
                                        ...
                                        <div class="meg_aminites">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="meg_aminites_item"><i class="fa-solid fa-shower"></i><span> SHOWER ROOM WITH ROYAL ACCESSORIES
                                                    </span></div>
                                                </div>
                                                <!-- <div class="col-lg-6">
